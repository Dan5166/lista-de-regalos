    ...
    <>
      <header className="bg-white border-b border-gray-100 shadow-sm">
        <div className="max-w-lg mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <h1 className="font-semibold text-gray-900">Nueva lista</h1>
        </div>
      </header>
        ...
        >
          <div>
            ...
            <input
              name="titulo"
              required
              placeholder="ej. Cumpleaños de Domy 2026"
          ...
          <div>
            ...
            <div className="flex items-center border border-gray-200 rounded-lg focus-within:ring-2 focus-within:ring-violet-500 focus-within:border-transparent transition overflow-hidden">
              <span className="pl-3 text-gray-400 text-sm select-none">/lista/</span>
              <input
                name="slug"
                required
                placeholder="domy-2026"
                className="flex-1 px-1 py-2.5 text-gray-900 placeholder-gray-400 focus:outline-none bg-transparent"
              />
            </div>
          ...
          <div>
            ...
            <textarea
              name="descripcion"
              rows={3}
              placeholder="Una descripción corta de la lista..."
